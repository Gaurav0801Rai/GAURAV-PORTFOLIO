...
const CertificateCard = ({ cert, aosDelay }) => (
  <a 
    href={cert.url || cert.pdf || '#'}
    target="_blank"
    rel="noopener noreferrer"
    data-aos="zoom-in"
    data-aos-delay={aosDelay}
    className="block bg-black/20 backdrop-blur-sm rounded-2xl p-5 border border-white/10 hover:border-white/25 hover:scale-105 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] transition-all duration-500 cursor-pointer group"
  >
