      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-red-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
            My professional career journey and industry achievements.
          </p>
        </div>

        {/* Internship Cards Grid - Centered dynamically if only one item exists */}
        <div className={`grid grid-cols-1 ${internshipsList.length > 1 ? 'lg:grid-cols-3' : 'max-w-2xl mx-auto'} gap-6 md:gap-8`}>
