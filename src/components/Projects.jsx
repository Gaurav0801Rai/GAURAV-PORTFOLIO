            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {project.links && project.links.demo !== undefined && (
                  ...
                  >
                    <ExternalLinkIcon />
                    {project.links.demo ? (project.links.aiEngine ? 'Live MVP Demo' : 'Live Demo') : 'Demo Coming Soon'}
                  </a>
                )}

                {project.links && project.links.aiEngine && (
                  <a 
                    href={project.links.aiEngine}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 rounded-full bg-purple-600 text-white text-xs font-bold hover:bg-purple-700 hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] transition-all duration-300 group/btn"
                  >
                ...
                {project.links && project.links.ppt && (
                  <a 
                    href={project.links.ppt}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs font-bold hover:bg-amber-500 hover:text-black transition-all duration-300 group/btn shadow-[0_0_12px_rgba(245,158,11,0.15)]"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
