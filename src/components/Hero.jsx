...
import heroVideo from '../assets/hero video/gaurav-hero.mp4';
...
const Hero = () => {
  ...
  const toggleVideo = (e) => {
    e.stopPropagation();
    if (videoRef.current) {
      // Initialize Audio Context for Volume Boost on user click
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="hidden lg:flex flex-col gap-4 fixed left-6 top-1/2 -translate-y-1/2 z-50">
        <a 
          ...
          className="w-12 h-12 rounded-full border border-white/20 bg-black/50 backdrop-blur-md flex justify-center items-center text-white/70 hover:text-white hover:bg-[#ff2a2a] hover:border-[#ff2a2a] hover:scale-115 hover:shadow-[0_0_20px_rgba(255,42,42,0.5)] transition-all duration-300 shadow-lg"
          aria-label="GitHub"
        >
        ...
        {socialLinks.nextleap && (
          <a 
            href={socialLinks.nextleap} 
            target="_blank" 
            rel="noopener noreferrer" 
            className="w-12 h-12 rounded-full border border-white/20 bg-black/50 backdrop-blur-md flex justify-center items-center text-white/70 hover:text-white hover:bg-[#ff2a2a] hover:border-[#ff2a2a] hover:scale-115 hover:shadow-[0_0_20px_rgba(255,42,42,0.5)] transition-all duration-300 shadow-lg"
            aria-label="NextLeap Portfolio"
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          <div 
            data-aos="fade-up"
            data-aos-delay="100"
            className="flex items-center gap-3.5 mb-6 lg:hidden"
          >
            <a 
              href={socialLinks.github} 
              target="_blank" 
              rel="noopener noreferrer" 
              className="w-11 h-11 rounded-full border border-white/20 bg-black/50 backdrop-blur-md flex justify-center items-center text-white/70 hover:text-white hover:bg-[#ff2a2a] hover:border-[#ff2a2a] hover:scale-110 transition-all duration-300 shadow-md" 
              aria-label="GitHub"
            >
              <svg className="w-[22px] h-[22px]" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" /></svg>
            </a>
            <a 
              href={socialLinks.linkedin} 
              target="_blank" 
          ...
          {heroContent.topBadge && (
            heroContent.topBadgeLink ? (
              <a 
                href={heroContent.topBadgeLink}
                target="_blank"
                rel="noopener noreferrer"
                data-aos="fade-up"
                data-aos-delay="50"
          ...
          >
            {heroContent.greeting}, <br /> <span className="text-black [-webkit-text-stroke:0.8px_#ffffff] font-black">{heroContent.titleHighlight}</span>
          </h1>
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border-2 border-white bg-black/40 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#ff2a2a] group-hover:border-[#ff2a2a] transition-all duration-500 shadow-[0_0_20px_rgba(255,255,255,0.7)] group-hover:shadow-[0_0_35px_rgba(255,42,42,0.8)]">
            {!isPlaying || isMuted ? (
              // Play Icon
          ...
          <span className="text-white text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-85 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)] group-hover:opacity-100 transition-opacity">
